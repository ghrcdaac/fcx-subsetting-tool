...
resource "aws_api_gateway_deployment" "subset_trigger_api_deployment" {
  ...
  triggers = {
    ...
    redeployment = sha1(jsonencode([
      ...
      # for subets_list_resource
      aws_api_gateway_resource.subsets_filename.id,
      aws_api_gateway_method.subsets_filename.id,
      aws_api_gateway_integration.subsets_filename_api_integration,
    ]))
  }
